...
?>
<h1>Myprofile</h1>
<?php $result2=mysqli_query($conn,"SELECT * from doctor where id=$var") ?>
<table class="">
...
<?php while($row2=mysqli_fetch_assoc($result2))
        {?>
                   ...
                   <td class="frm"><input style="width:80px" class="" name="email" value="<?php echo $row2["email"] ?>" readonly></td>
                    ...
                    <td class="frm"><a  href="editdoctorprofile.php"  class="btn-primary mt-md-3 px-5 rounded shadow">EDIT</a>
