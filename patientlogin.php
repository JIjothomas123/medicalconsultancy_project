			...
			<div class="container-fluid bg-style media1">
				...
				<div class="row">
					...
					<div class="col-md-12 log-style">
						<form action="patientauthentication.php" name="login" method="post" onsubmit="return validateForm()" class="m-auto py-3 jumbotron text-light p-3 form-style rounded">
							...
							<button type="submit" class="btn-primary mt-md-3 px-5 rounded shadow" name="submit">Sign IN</button>
								...
								<div class='text-center m-t-10'>
									<a class="text-dark" href="patientsignup.php">new user? signup</a>
								</div>
