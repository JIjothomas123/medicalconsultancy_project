	<!------------------doctor base page ibnncluding navigation bar----------------------->
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item active">
        ...
        <div class="side">
				<ul>
					<li>
                        <a href="doctorprofile.php">myprofile</a>
        ...
        <div class="side">
				<ul>
					<li>
                        <a href="doctorviewcalendar.php">View calendar</a>
          ...
          <div class="side">
				<ul>
					<li>
                        <a href="managePatientappointments.php">Appointments</a>
