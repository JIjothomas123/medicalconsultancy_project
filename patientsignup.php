...
<form role="form" class="" name="Myform"  action="insertpatient.php" method="post" onsubmit="return form()">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control"  name="gender" id="gender" required="required">
  </div>
  <div class="form-group">
